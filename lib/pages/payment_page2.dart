...
class ConfirmServicePayment extends StatefulWidget {
  const ConfirmServicePayment({Key? key}) : super(key: key);

  @override
  ConfirmServicePaymentState createState() => ConfirmServicePaymentState();
}

class ConfirmServicePaymentState extends State<ConfirmServicePayment> {
  DateTime selectedDate = DateTime.now();
  String selectedProvider = 'AzamPesa'; // Default value
  String defaultPrice = "10000";
  String phoneNumber = "";
          ...
          return Padding(
            ...
            child: Column(
              ...
              children: [
                const Center(
                  child: Text(
                    'Emergency Service Request Payment',
                    style: TextStyle(
                      fontSize: 22,
                      fontWeight: FontWeight.bold,
                    ),
                        ...
                        Row(
                          children: [
                            ...
                            FutureBuilder<String>(
                              ...
                              // Future method to get user's phone number from shared preferences
                              builder: (context, snapshot) {
                                if (snapshot.connectionState == ConnectionState.waiting) {
                                  // Show a loading indicator while waiting for the data
                                  return CircularProgressIndicator();
                                  ...
                                  // Display the user's phone number if data is retrieved successfully
                                  return Text(
                                    '${snapshot.data}',
                                    style: TextStyle(
                                      fontWeight: FontWeight.bold,
                      ...
                      if (book.requestSuccessful == true) {
                        toastification.show(
                          ...
                          description: RichText(
                            text: TextSpan(text: book.resMessage),
                          ),
